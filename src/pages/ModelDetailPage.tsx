        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="flex gap-4 justify-center">
              <button 
                onClick={() => navigate(-1)}
                className="bg-dark-secondary text-text-primary px-4 py-2 rounded-lg hover:bg-dark-tertiary transition-colors"
              >
                返回上页
              </button>
              <Link
  ...
  return (
    <div className="min-h-screen bg-dark-primary py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* 模型基本信息 */}
        <div className="bg-dark-secondary border border-dark-border rounded-lg p-8 mb-8">
          <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6">
            <div className="flex-1">
              {/* 品牌标签 */}
              <div className="mb-4">
                <span className="inline-block px-3 py-1 bg-orange-primary/20 text-orange-primary text-sm font-medium rounded-full">
                  {model.brand}
                </span>
              </div>
            ...
            <div className="flex flex-col gap-3 lg:w-48">
              ...
              <Link
                to="/compare"
                className="w-full py-2 px-4 bg-dark-tertiary text-text-primary text-center rounded-lg hover:bg-dark-border transition-colors"
              >
                查看对比
              </Link>
            </div>
              ...
              <div className="bg-dark-secondary border border-dark-border rounded-lg p-6">
                ...
                <div className="space-y-6">
                  {model.providers.map((provider, index) => (
                    <div key={provider.name} className={`${index !== model.providers.length - 1 ? 'border-b border-dark-border pb-6' : ''}`}>
                      <div className="flex items-center justify-between mb-4">
                        <div className="flex items-center gap-3">
                          <h3 className="text-lg font-semibold text-text-primary">
                            {provider.display_name}
                          </h3>
                          {model.recommended_provider === provider.name && (
                            <span className="px-2 py-1 bg-orange-primary/20 text-orange-primary text-xs font-medium rounded-full">
                              推荐
                            </span>
                          )}
                        </div>
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-green-400 font-semibold">
                            {provider.reliability_score.toFixed(1)}/10
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <div className="bg-dark-primary rounded-lg p-3">
                          <div className="flex items-center gap-2 mb-1">
                            ...
                            <span className="text-text-secondary text-sm">响应时间</span>
                          </div>
                          <p className="text-text-primary font-semibold">
                        ...
                        <div className="bg-dark-primary rounded-lg p-3">
                          <div className="flex items-center gap-2 mb-1">
                            ...
                            <span className="text-text-secondary text-sm">正常运行时间</span>
                          </div>
                          <p className="text-text-primary font-semibold">
                        ...
                        <div className="bg-dark-primary rounded-lg p-3">
                          <div className="flex items-center gap-2 mb-1">
                            ...
                            <span className="text-text-secondary text-sm">服务区域</span>
                          </div>
                          <p className="text-text-primary font-semibold">
                            {provider.region}
                          </p>
                        ...
                        <div className="bg-dark-primary rounded-lg p-3">
                          <div className="flex items-center gap-2 mb-1">
                            <ServerIcon className="h-4 w-4 text-text-muted" />
                            <span className="text-text-secondary text-sm">流式响应</span>
                          </div>
                          <p className="text-text-primary font-semibold">
                            {provider.support_streaming ? '支持' : '不支持'}
                          </p>
                        </div>
                      </div>
                    </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 bg-dark-primary border border-dark-border rounded-lg text-text-primary focus:outline-none focus:ring-2 focus:ring-orange-primary"
                    min="0"
                  />
                </div>
                ...
                {priceResult && (
                  <div className="mt-6 p-4 bg-dark-primary rounded-lg">
                ...
                <div className="space-y-4">
                  {similarModels.map((similarModel) => (
                    <Link
                      ...
                      className="block p-4 bg-dark-primary rounded-lg hover:bg-dark-tertiary transition-colors"
                    >
